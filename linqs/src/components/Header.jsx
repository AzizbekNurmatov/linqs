    ...
    <>
      ...
      <header className="fixed top-6 left-1/2 -translate-x-1/2 max-w-5xl w-[90%] h-16 rounded-xl bg-white border-[3px] border-black shadow-[5px_5px_0px_0px_rgba(0,0,0,1)] z-50">
        <nav className="flex items-center h-full">
          {/* Left: Brand */}
          <div className="flex items-center gap-2 px-3 md:px-6 h-full border-r-2 border-black">
          ...
          {/* Right: Actions */}
          <div className="flex items-center gap-2 md:gap-4 px-3 md:px-6 h-full flex-1 justify-end">
            ...
            {onOpenSavedEvents && (
              <button
                ...
                className="hidden sm:block text-black hover:bg-[#FEF08A] transition-colors duration-200 p-2 -mx-2"
            ...
            <button
              ...
              className="bg-[#FF69B4] text-white border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] px-3 sm:px-6 py-2.5 font-bold text-sm flex items-center gap-2 active:shadow-none active:translate-y-[2px] transition-all duration-100"
            >
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-40 md:hidden px-4 pt-24 pb-6">
          <div className="h-[calc(100vh-6rem)] w-[95vw] max-w-5xl mx-auto bg-white rounded-xl border-[3px] border-black shadow-[5px_5px_0px_0px_rgba(0,0,0,1)] overflow-y-auto">
      ...
      {showForm && (
        <div
          className="fixed inset-0 bg-black/20 backdrop-blur-sm z-50 flex items-center justify-center p-3 md:p-4"
          onClick={handleCloseForm}
        >
          <div
            className="bg-white rounded-3xl max-w-2xl w-[95vw] sm:w-full max-h-[90vh] overflow-hidden shadow-2xl flex flex-col"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="modal-scroll p-4 md:p-6 w-full">
